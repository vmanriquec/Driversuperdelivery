...
import com.driversuperdelivery.driversuperdelivery.modelos.Message;
...
//                    .icon(bitmapDescriptorFromVector(this,R.drawable.ic_moto))
        ...
        Picasso.get().load(R.drawable.src_files_homeselect).transform(new CropCircleTransformation()).resize(100, 100).into(markero);
